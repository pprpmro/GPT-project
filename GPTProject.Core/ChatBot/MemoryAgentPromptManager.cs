namespace GPTProject.Core.ChatBot
{
	public static partial class PromptManager
	{
		...
		public static string GetSummaryContentPrompt() =>
			$"Сделай саммари диалога, концентрируйся на том, что произошло, напиши все одним текстом, без форматирования";
		...
		public static string GetRemakePlanPrompt() =>
			...
			$"на чем остановились, что еще нужно сделать";
