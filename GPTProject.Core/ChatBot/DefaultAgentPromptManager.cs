namespace GPTProject.Core.ChatBot
{
	public static partial class PromptManager
	{
		...
		public static string GetSmallTalkPrompt(string subjectArea) =>
			...
			"Если вы получаете вопрос по твоей теме, в которой ты эксперт, то ВАМ НАДО ОБРАТИТЬСЯ К ВНУТРЕНЕЙ БРАЗЕ ЗНАНИЙ, ничего не отвечайте, а верните оригинальное сообщение пользователя в формате:\n" +
