namespace GPTProject.Core.ChatBot
{
	public static class PromptManager
	{
		...
		public static string GetSmallTalkPrompt(string subjectArea) =>
			...
			"Сейчас твоя задача – разделить сообщение пользователя на две части:\n" +
			"1. Информационные вопросы – осмысленные вопросы или запросы по теме, которые требуют ответа.\n" +
			"2. Small talk – приветствия, шутки, вежливые фразы, не относящиеся к теме, или общие вопросы по типу \"кто ты?\" или \"зачем ты здесь?\".\n" +
			$"Ни в коем случае не выходи за рамки своей предметной области, если пользователь спрашивает не по теме, вежливо отказывай ему\n" +
			$"Но ты можешь отвечать на простые Small talk вопросы" +
			...
			"- Короткие запросы, но по теме (\"А как это?\") – это тоже вопросы, не удаляй их.\n" +
			...
			"Формат ответа:\n" +
			"QUESTIONS: <оригинальное сообщение без small talk, если содержит вопрос, если нет – 'EMPTY'>\n" +
