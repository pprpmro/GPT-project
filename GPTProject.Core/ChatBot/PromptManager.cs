namespace GPTProject.Core.ChatBot
{
	public static class PromptManager
	{
		...
		public static string GetRestoringPrompt() =>
			...
			$"\r\n\"Имя пользователя\"" +
			$"\r\n\"LLL. Предпочтения. Какой любимый цвет" +
			$"\"\r\n" +
			$"]\r\n" +
			$"В случае если запрос не содержит важной информации, старайся вытянуть общую информацию (имя, возраст, предпочтения) об обоих участниках диалога (пользователь и LLM). Обработай следующий запрос:";
