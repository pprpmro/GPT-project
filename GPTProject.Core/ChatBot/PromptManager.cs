	...
	public static class PromptManager
	{
		public static string GetSystemPrompt(string subjectArea, List<string>? sources)
		{
			...
			var systemPrompt =
				...
				$"\n\nФормат ответа (JSON):" +
				$"\n{{" +
				$"\n  \"response\": \"<краткий ответ (пустое, если нужно уточнение)>\"," +
				$"\n  \"clarificationQuestion\": \"<уточняющий вопрос, если нужно уточнение>\"" +
				$"\n}}" +
		...
		public static string GetSmallTalkPrompt(string subjectArea) =>
			...
			"{\n" +
			"  \"QUESTIONS\": \"<Список вопросов и запросов через `;`, если их нет – 'EMPTY'>\",\n" +
